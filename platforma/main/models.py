...
class Service(models.Model):
    ...
    image = models.ImageField(upload_to='service/images/', help_text="O'lcham: 371x202 px")
    book_image = models.ImageField(upload_to='book/images/', help_text="O'lcham: 160x250 px")


class ServiceBook(models.Model):
    service = models.ForeignKey(Service, on_delete=models.PROTECT)
    file = models.FileField(upload_to='book/file/', validators=[FileExtensionValidator(allowed_extensions=['pdf', 'doc', 'docx'])] )
